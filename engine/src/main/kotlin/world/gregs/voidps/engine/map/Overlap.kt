...
object Overlap {
    ...
    fun isUnder(tile: CoordGrid, size: Int, target: CoordGrid, targetSize: Int) = isUnder(tile.x, tile.y, size, size, target.x, target.y, targetSize, targetSize)

    fun isUnder(tile: CoordGrid, width: Int, height: Int, target: CoordGrid, targetWidth: Int, targetHeight: Int) = isUnder(tile.x, tile.y, width, height, target.x, target.y, targetWidth, targetHeight)
