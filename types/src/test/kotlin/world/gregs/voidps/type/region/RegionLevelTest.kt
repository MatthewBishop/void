...
internal class RegionLevelTest {
    ...
    fun `Cuboid test`() {
        ...
        assertFalse(cuboid.contains(CoordGrid(134, m, 2)))
        assertFalse(cuboid.contains(CoordGrid(127, m, 1)))
        assertTrue(cuboid.contains(CoordGrid(128, m, 1)))
        assertFalse(cuboid.contains(CoordGrid(192, m, 1)))
        assertTrue(cuboid.contains(CoordGrid(191, m, 1)))
        assertFalse(cuboid.contains(CoordGrid(m, 127, 1)))
        assertTrue(cuboid.contains(CoordGrid(m, 128, 1)))
        assertFalse(cuboid.contains(CoordGrid(m, 192, 1)))
        assertTrue(cuboid.contains(CoordGrid(m, 191, 1)))
    }
